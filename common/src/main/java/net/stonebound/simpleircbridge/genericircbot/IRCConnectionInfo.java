...
public class IRCConnectionInfo {
    ...
    /**
     * @param nickname nickname to use on IRC, must be valid
     * @param ident    ident/username passed to the IRC server
     * @param gecos    gecos/realname passed to the IRC server
     */
